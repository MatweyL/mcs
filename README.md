...
27. [x] Добавить проверку выполнения студентом УТК
    ...
    28. [x] **MCS-36** - (BE) Реализовать API для кнопок "Начать", "Закончить"
...
29. [ ] Режим тренировки
    29. [ ] **MCS-38** - (FE) Добавление компонентов для отрисовки подсказок
    29. [ ] **MCS-39** - (FE) Добавление API для получения информации о шаге тренировки
    29. [ ] Реализация API для получения информации о шаге тренировки
    
        29. [ ] **MCS-40** - (BE) Реализация проверки тренировки
        30. [ ] **MCS-41** - (FE) Интеграция

30. [ ] **MCS-42** - Установление связи между устройствами
    31. [ ] **MCS-43** - (FE) Добавление экрана "Направления" 
    31. [ ] **MCS-44** - (BE) Обработка выбора текущего направления 
    31. [ ] **MCS-45** - (BE) Обработка нажатия "Вызов" 
    31. [ ] **MCS-46** - (BE) Реализация поиска каналов с заданной частотой 
    31. [ ] **MCS-47** - (FE) Отображение уведомления  
